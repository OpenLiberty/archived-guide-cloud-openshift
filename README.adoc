...
Starter and Pro. You will use the Starter plan, which includes a free trial of their platform with limited resources, perfect for individual 
experimentation. The Pro plan includes more resources and has a monthly fee. To sign up, refer to the 
https://manage.openshift.com/register/plan[official website^]. Keep in mind that the creation time depends on resource 
availability and may take some time. 
