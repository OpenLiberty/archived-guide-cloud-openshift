...
properties taken from the `system-service` are automatically stored in the inventory. Go back to `http://[inventory-hostname]/inventory/systems` 
...
To delete the pushed images, run the following `oc delete` commands:
