...
:page-related-guides: ['kubernetes-intro', 'kubernetes-microprofile-config', 'kubernetes-microprofile-health', 'istio-intro', 'operator-openshift'] 
...
For deploying to an OpenShift 4 cluster, see the https://openliberty.io/guides/operator-openshift[OpenShift Operator^] guide. 
