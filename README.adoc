...
cluster on OpenShift, Red Hat's cloud platform.
...
to use for the container. The image address used is the OCR address that you logged into, simply update the system 
