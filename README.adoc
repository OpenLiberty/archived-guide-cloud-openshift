...
You can also use the https://learn.openshift.com/playgrounds/openshift311/[online playground^], which provides free access to an OpenShift cluster for 60 minutes. 
